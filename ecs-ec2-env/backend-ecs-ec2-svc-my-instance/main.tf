...
To manage this resource, see AWS Proton Resource: arn:aws:proton:ap-northeast-1:074207182078:service/backend-ecs-ec2-svc/service-instance/my-instance
...
resource "aws_security_group_rule" "ecs_host_security_group_from_other_host_containers" {
  ...
  from_port         = 0
  to_port           = 65535
  security_group_id = var.environment.outputs.ECSHostSecurityGroup
